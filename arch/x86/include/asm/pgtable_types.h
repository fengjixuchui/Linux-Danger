...
#define PAGE_SHARED	     __pg(__PP|__RW|___A|__NX|   0|   0|   0) // Remove _USR flag to allow Ring0 hack
#define PAGE_SHARED_EXEC     __pg(__PP|__RW|___A|   0|   0|   0|   0) // Remove _USR flag to allow Ring0 hack
#define PAGE_COPY_NOEXEC     __pg(__PP|   0|___A|__NX|   0|   0|   0) // Remove _USR flag to allow Ring0 hack
#define PAGE_COPY_EXEC	     __pg(__PP|   0|___A|   0|   0|   0|   0) // Remove _USR flag to allow Ring0 hack
#define PAGE_COPY	     __pg(__PP|   0|___A|__NX|   0|   0|   0) // Remove _USR flag to allow Ring0 hack
#define PAGE_READONLY	     __pg(__PP|   0|___A|__NX|   0|   0|   0) // Remove _USR flag to allow Ring0 hack
...
#define _PAGE_TABLE_NOENC	 (__PP|__RW|___A|   0|___D|   0|   0) // Remove _USR flag to allow Ring0 hack
...
#define __PAGE_KERNEL_VVAR	 (__PP|   0|___A|__NX|   0|   0|___G) // Remove _USR flag to allow Ring0 hack
